...
INSERT INTO dbo.Usuarios ( nc ,nombres ,apellidopat ,apellidomat ,sexo ,password ,foto ,hora ,fecha)
VALUES  ('14540075','César Raúl','González','López','H','1234',NULL,CONVERT(TIME,GETDATE(),103),CONVERT(DATE,GETDATE(),108))
INSERT INTO dbo.Usuarios (nc,nombres,apellidopat,apellidomat,sexo,password,hora,fecha) VALUES
('14540074','José Luis','Rubio','Pérez','H','1234',CONVERT(TIME,GETDATE(),108),CONVERT(DATE,GETDATE(),103))
...
SELECT * FROM Administradores --VER TABLA "Administradores"
